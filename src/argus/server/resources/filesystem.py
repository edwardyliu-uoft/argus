...
from argus.plugins import MCPResourcePlugin


_logger = logging.getLogger("argus.console")


class FilesystemResourcePlugin(MCPResourcePlugin):
    """Plugin wrapper for filesystem resources"""
    ...
    async def get_solidity_files(self) -> str:
        """
